export let algorithm = (() => {
    ...
    let calculate = (controller, controllers, isOpened) => {

        switch (controller) {
            case "five": {
                if (!(controllers[0].isOpen && controllers[1].isOpen && controllers[2].isOpen
                    && controllers[3].isOpen)) {
            ...
            case "two": {
                if (!controllers[0].isOpen && !controllers[2].isOpen && controllers[3].isOpen
                    && controllers[4].isOpen) {
            ...
            case "three": {
                if (!controllers[0].isOpen && !controllers[1].isOpen && controllers[3].isOpen
                    && controllers[4].isOpen) {
            ...
            case "one": {
                if (controllers[0].isOpen && controllers[1].isOpen && !controllers[2].isOpen
                    && controllers[3].isOpen && controllers[4].isOpen) {
                    this.isSafe = true;
